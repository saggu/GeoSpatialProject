...
Gr0wl.Base = new Class({
    ...
    initialize: function(image) {
        this.image = new Asset.image(image, {
    ...
    create: function(styles) {
        ...
        styles.div)).setOpacity(0).injectInside(document.body);
...
window.addEvent('domready', function() {
    Growl.Bezel = new Gr0wl.Bezel('images/bezel.png');
