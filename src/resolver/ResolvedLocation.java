...
import extractor.LocationOccurrence;
import org.apache.lucene.document.Document;

import gazetteer.GeoName;

import static util.DamerauLevenshtein.damerauLevenshteinDistanceCaseInsensitive;
...
public class ResolvedLocation {
    ...
    public String toString() {
    	...
    	//return location.text + "," + geoname + "," + location.position + "," + geoname.longitude + "," + geoname.latitude + "\n";
    }
*/}
